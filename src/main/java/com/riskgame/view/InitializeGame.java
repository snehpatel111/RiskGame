...
public class InitializeGame {
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            System.out.println("\n=================== Welcome To RiskGame! ======================\n");
            while (true) {
                System.out.println("Enter S to play single-game Mode OR T to play tournament-game Mode OR Q to quit/exit the game");
                l_cmd = sc.nextLine();
                switch (l_cmd) {
                    case "S":
                        l_GameEngine.getCurrentGamePhase().getGameState().updateLog("Initializing the Game ......" + System.lineSeparator(),
                                "start");
                    ...
                    case "T":
                        ...
                        do {
                            System.out.println("Command has to be in form of 'tournament -M listofmapfiles{1-5} -P listofplayerstrategies{2-4}"+""
