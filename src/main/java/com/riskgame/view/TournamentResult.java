...
public class TournamentResult {
     ...
     * Displays the result of the tournament
     * 
     * @param p_winner HashMap representing the winner of the game indexed based on
     *                 the number of the game.
     * @param p_maps   List of maps used to play the tournament.
     */
    public void showTournamentWinner(HashMap<Integer, String> p_winner, ArrayList<String> p_maps) {
