...
public class GameData extends Observable implements Serializable {
     ...
     */
    public GameData(GameMap p_map, String p_mapType, Phase p_gamePhase, Phase p_phase, ArrayList<Player> p_players,
            Player p_activePlayer, Card p_card, String p_phaseName) {
        this.d_Map = p_map;
     ...
     * 
     * @return Type of the map, i.e. 'Conquest' format map or 'Domination' format
     *         map
     */
     ...
     * 
     * @param p_mapType Type of the map, i.e. 'Conquest' format map or 'Domination'
     *                  format map
     */
